...
import "../App.css";
import test from "./Images/defaultuser.png";
...
const trackedProducts = [
  {
    ...
    reviews: "It is very good has quality camera",
  },
  {
    id: 2,
    ...
    price: "$199.99",
    description: "this is very confortable and light to wear",
    reviews: "",
  },
    ...
    const fetchUserData = async () => {
      try {
        const response = await axios.get(
          `http://127.0.0.1:8000/selecto/api/userdetails/${user_id}/`
        );
